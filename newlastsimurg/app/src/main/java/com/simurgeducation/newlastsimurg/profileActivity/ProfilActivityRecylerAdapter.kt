...
class ProfilActivityRecylerAdapter(
...
): RecyclerView.Adapter<ProfilActivityRecylerAdapter.PostHolder>(){
    override fun onCreateViewHolder(
        ...
        val binding=
            RecylerViewRowBinding.inflate(LayoutInflater.from(parent.context),parent,false)
        return PostHolder(binding)


    }

    override fun onBindViewHolder(holder: ProfilActivityRecylerAdapter.PostHolder, position: Int) {
        holder.binding.profiletexttv?.text=usernamelist
